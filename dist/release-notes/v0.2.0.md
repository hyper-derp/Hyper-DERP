...
[Homelab quickstart](docs/wireguard_relay_quickstart.md) — eight copy-paste steps from a clean Debian box.
...
Full changelog: [CHANGELOG.md](CHANGELOG.md) · Bench numbers: [HD.Benchmark](https://github.com/hyper-derp/HD.Benchmark)
