...
If you want to chase throughput on real silicon (10/25 GbE NICs, cloud) there's an XDP fast-path mode — see [`wireguard_relay_bench.md`](wireguard_relay_bench.md) and [`wireguard_relay_bench_25g.md`](wireguard_relay_bench_25g.md). For homelab speeds the userspace path is fine.
